...
INSERT INTO
    t_venue_code_info(code_id, venue_type, venue_location, venue_name)
VALUES
       ('341435272146546544', '交通场所', '湖南省 长沙市 岳麓区 橘子洲街道 47号', 'A地铁站'),
       ('687321357845679823', '交通场所', '湖南省 长沙市 岳麓区 橘子洲街道 89号', 'B地铁站');

-- 行程信息
INSERT INTO
    t_itinerary_information(person_id, venue_id, record_time)
VALUES
       ('457342192208107100', '341435272146546544', '2021-03-02 14:59:36'),
       ('457342192208107100', '687321357845679823', '2021-03-02 14:14:14');

INSERT INTO
    t_remote_reporting(report_id, person_name, person_id, img_url, _from, _to, additional_info)
VALUES
       ('341415793546546544', '姜洋', '457342192208107100', '', '湖南', '湖北', null),
       ('169798145436736872', '姜洋', '457342192208107100', '', '湖北', '四川', null);
